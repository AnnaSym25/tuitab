...
pub fn render_help_popup(frame: &mut Frame, area: Rect) {
    ...
    let help_text = vec![
        ...
        Line::from("  zw                Window column (rank, running total, lag)"),
        Line::from("                    a running total asks what orders the rows;"),
        Line::from("                    the table itself is not re-sorted"),
        ...
        Line::from("  z[ / z]           Add another sort key (asc / desc)"),
        Line::from("  r                 Reset to original row order"),
        Line::from(""),
        Line::from(Span::styled(
            "── Type Assignment (t) ─────────────────",
            Style::default().fg(T::GREEN),
        ...
        Line::from("  gb               Group by pinned cols (aggregates from +)"),
        ...
        Line::from("  Enter            Dive into the row's node"),
        ...
        Line::from("  o                 Add an empty row below the cursor"),
        Line::from("  O                 New-row form — a field per column, checked by type"),
